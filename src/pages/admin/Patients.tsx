...
import { IPatient } from "../../models/user";
...
export default function EnhancedTable() {
  ...
  const [orderBy, setOrderBy] = useState<keyof IPatient>("fullName");
      ...
      <Paper className={classes.paper}>
        ...
        <TableContainer>
          ...
          >
            ...
            />
            <TableBody>
              {stableSort<IPatient>(rows, getComparator(order, orderBy))
