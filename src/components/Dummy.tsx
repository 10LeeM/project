    ...
    <div className="details">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>070000000</td>
              <td>500/=</td>
              <td><span className="status del">Pending</span></td>
            </tr>
            <tr>
              <td>Doe</td>
              <td>mirriam@gmail.com</td>
      ...
      <div className="recentsDoctors">
        ...
        <table>
          <tbody>
            <tr>
              <td width="60px"><div className="imgBx"><img src="image/image.png" /></div></td>
              <td><h4>David<br /><span>Kiambu</span></h4></td>
            </tr>
            <tr>
              <td width="60px"><div className="imgBx"><img src="image/image.png" /></div></td>
              <td><h4>David<br /><span>Kiambu</span></h4></td>
            ...
            <tr>
              <td width="60px"><div className="imgBx"><img src="image/image.png" /></div></td>
              <td><h4>David<br /><span>Nairobi</span></h4></td>
            </tr>
            <tr>
              <td width="60px"><div className="imgBx"><img src="image/image.png" /></div></td>
              <td><h4>David<br /><span>Nairobi</span></h4></td>
            ...
            <tr>
              <td width="60px"><div className="imgBx"><img src="image/image.png" /></div></td>
              <td><h4>David<br /><span>Medic</span></h4></td>
            </tr>
            <tr>
              <td width="60px"><div className="imgBx"><img src="image/image.png" /></div></td>
              <td><h4>David<br /><span>Medic</span></h4></td>
